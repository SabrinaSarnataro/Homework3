...
def generate_launch_description():
    ...
    #this is a launch argument that allows to activate or not the camera on the end_effector. The default value is false.
   
    declared_arguments.append(
        DeclareLaunchArgument(
            'use_vision',
            default_value='false',
            description='Enable the camera on the end-effector'
        )
    )
    ...
    robot_description_content = Command(
        [
            ...
            ' ',
            'use_vision:=',
            LaunchConfiguration('use_vision'), #I added this
        ]
    )
    ...
    declared_arguments.append(DeclareLaunchArgument('gz_args', default_value=[iiwa_simulation_world, ' -r -v 1'],
