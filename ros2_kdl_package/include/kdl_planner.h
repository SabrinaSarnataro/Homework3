...
public:
    ...
    void trapezoidal_vel(double t, double tc, double &s, double &sd, double &sdd);
    void cubic_polynomial(double t, double &s, double &sd, double &sdd); 
    
    KDLPlanner(double _trajDuration, Eigen::Vector3d _trajInit, double _trajRadius, double accDuration_);
