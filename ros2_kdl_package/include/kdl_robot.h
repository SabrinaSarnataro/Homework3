...
public:
    ...
    void update(std::vector<double> _jnt_values,std::vector<double> _jnt_vel, std::vector<double> _jnt_eff);
...
private:
    ...
    // joints
    void updateJnts(std::vector<double> _jnt_values, std::vector<double> _jnt_vel, std::vector<double> _jnt_eff);
